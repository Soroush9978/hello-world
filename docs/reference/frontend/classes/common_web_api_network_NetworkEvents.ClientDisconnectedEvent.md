---
id: "common_web_api_network_NetworkEvents.ClientDisconnectedEvent"
title: "Class: ClientDisconnectedEvent"
sidebar_label: "ClientDisconnectedEvent"
custom_edit_url: null
---

[common/web/api/network/NetworkEvents](../modules/common_web_api_network_NetworkEvents.md).ClientDisconnectedEvent
...
• **new ClientDisconnectedEvent**(`name`, `origin`, `sender`, `target`, `hops?`, `trace?`): [`ClientDisconnectedEvent`](common_web_api_network_NetworkEvents.ClientDisconnectedEvent.md)
...
▸ **build**(`messageBuilder`, `chain?`): [`EventComposer`](common_web_core_messaging_composers_EventComposer.EventComposer.md)<[`ClientDisconnectedEvent`](common_web_api_network_NetworkEvents.ClientDisconnectedEvent.md)\>
...
[`EventComposer`](common_web_core_messaging_composers_EventComposer.EventComposer.md)<[`ClientDisconnectedEvent`](common_web_api_network_NetworkEvents.ClientDisconnectedEvent.md)\>

#### Defined in

[common/web/api/network/NetworkEvents.ts:30](https://github.com/Soroush9978/rds-ng/blob/165bdc6/src/common/web/api/network/NetworkEvents.ts#L30)
