...
[common/web/api/network/NetworkEvents.ts:77](https://github.com/Soroush9978/rds-ng/blob/9a997cb/src/common/web/api/network/NetworkEvents.ts#L77)
...
[common/web/api/network/NetworkEvents.ts:76](https://github.com/Soroush9978/rds-ng/blob/9a997cb/src/common/web/api/network/NetworkEvents.ts#L76)
...
[common/web/api/network/NetworkEvents.ts:82](https://github.com/Soroush9978/rds-ng/blob/9a997cb/src/common/web/api/network/NetworkEvents.ts#L82)
