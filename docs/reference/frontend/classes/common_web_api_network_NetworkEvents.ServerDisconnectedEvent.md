---
id: "common_web_api_network_NetworkEvents.ServerDisconnectedEvent"
title: "Class: ServerDisconnectedEvent"
sidebar_label: "ServerDisconnectedEvent"
custom_edit_url: null
---

[common/web/api/network/NetworkEvents](../modules/common_web_api_network_NetworkEvents.md).ServerDisconnectedEvent
...
• **new ServerDisconnectedEvent**(`name`, `origin`, `sender`, `target`, `hops?`, `trace?`): [`ServerDisconnectedEvent`](common_web_api_network_NetworkEvents.ServerDisconnectedEvent.md)
...
[common/web/api/network/NetworkEvents.ts:77](https://github.com/Soroush9978/rds-ng/blob/165bdc6/src/common/web/api/network/NetworkEvents.ts#L77)
...
[common/web/api/network/NetworkEvents.ts:76](https://github.com/Soroush9978/rds-ng/blob/165bdc6/src/common/web/api/network/NetworkEvents.ts#L76)
...
[common/web/core/messaging/Event.ts:9](https://github.com/Soroush9978/rds-ng/blob/165bdc6/src/common/web/core/messaging/Event.ts#L9)
...
[common/web/core/messaging/Event.ts:14](https://github.com/Soroush9978/rds-ng/blob/165bdc6/src/common/web/core/messaging/Event.ts#L14)
...
▸ **build**(`messageBuilder`, `compID`, `clientID`, `chain?`): [`EventComposer`](common_web_core_messaging_composers_EventComposer.EventComposer.md)<[`ServerDisconnectedEvent`](common_web_api_network_NetworkEvents.ServerDisconnectedEvent.md)\>
...
[`EventComposer`](common_web_core_messaging_composers_EventComposer.EventComposer.md)<[`ServerDisconnectedEvent`](common_web_api_network_NetworkEvents.ServerDisconnectedEvent.md)\>

#### Defined in

[common/web/api/network/NetworkEvents.ts:82](https://github.com/Soroush9978/rds-ng/blob/165bdc6/src/common/web/api/network/NetworkEvents.ts#L82)
