...
[common/web/api/network/NetworkEvents.ts:42](https://github.com/Soroush9978/rds-ng/blob/5673246/src/common/web/api/network/NetworkEvents.ts#L42)
...
[common/web/api/network/NetworkEvents.ts:47](https://github.com/Soroush9978/rds-ng/blob/5673246/src/common/web/api/network/NetworkEvents.ts#L47)
