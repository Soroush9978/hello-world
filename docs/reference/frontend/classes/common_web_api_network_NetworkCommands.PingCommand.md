...
[common/web/api/network/NetworkCommands.ts:13](https://github.com/Soroush9978/rds-ng/blob/165bdc6/src/common/web/api/network/NetworkCommands.ts#L13)
...
[common/web/api/network/NetworkCommands.ts:18](https://github.com/Soroush9978/rds-ng/blob/165bdc6/src/common/web/api/network/NetworkCommands.ts#L18)
