---
id: "common_web_api_network_NetworkCommands.PingCommand"
title: "Class: PingCommand"
sidebar_label: "PingCommand"
custom_edit_url: null
---

[common/web/api/network/NetworkCommands](../modules/common_web_api_network_NetworkCommands.md).PingCommand
...
• **new PingCommand**(`name`, `origin`, `sender`, `target`, `hops?`, `trace?`): [`PingCommand`](common_web_api_network_NetworkCommands.PingCommand.md)
...
• `Readonly` **payload**: `string` = `"PING"`

#### Defined in

[common/web/api/network/NetworkCommands.ts:13](https://github.com/Soroush9978/rds-ng/blob/9a997cb/src/common/web/api/network/NetworkCommands.ts#L13)
...
▸ **build**(`messageBuilder`, `chain?`): [`CommandComposer`](common_web_core_messaging_composers_CommandComposer.CommandComposer.md)<[`PingCommand`](common_web_api_network_NetworkCommands.PingCommand.md)\>
...
[`CommandComposer`](common_web_core_messaging_composers_CommandComposer.CommandComposer.md)<[`PingCommand`](common_web_api_network_NetworkCommands.PingCommand.md)\>

#### Defined in

[common/web/api/network/NetworkCommands.ts:18](https://github.com/Soroush9978/rds-ng/blob/9a997cb/src/common/web/api/network/NetworkCommands.ts#L18)
