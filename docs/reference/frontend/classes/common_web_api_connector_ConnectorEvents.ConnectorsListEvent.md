---
id: "common_web_api_connector_ConnectorEvents.ConnectorsListEvent"
title: "Class: ConnectorsListEvent"
sidebar_label: "ConnectorsListEvent"
custom_edit_url: null
---

[common/web/api/connector/ConnectorEvents](../modules/common_web_api_connector_ConnectorEvents.md).ConnectorsListEvent
...
• **new ConnectorsListEvent**(`name`, `origin`, `sender`, `target`, `hops?`, `trace?`): [`ConnectorsListEvent`](common_web_api_connector_ConnectorEvents.ConnectorsListEvent.md)
...
[common/web/api/connector/ConnectorEvents.ts:18](https://github.com/Soroush9978/rds-ng/blob/165bdc6/src/common/web/api/connector/ConnectorEvents.ts#L18)
...
▸ **build**(`messageBuilder`, `connectors`, `chain?`): [`EventComposer`](common_web_core_messaging_composers_EventComposer.EventComposer.md)<[`ConnectorsListEvent`](common_web_api_connector_ConnectorEvents.ConnectorsListEvent.md)\>
...
[`EventComposer`](common_web_core_messaging_composers_EventComposer.EventComposer.md)<[`ConnectorsListEvent`](common_web_api_connector_ConnectorEvents.ConnectorsListEvent.md)\>

#### Defined in

[common/web/api/connector/ConnectorEvents.ts:23](https://github.com/Soroush9978/rds-ng/blob/165bdc6/src/common/web/api/connector/ConnectorEvents.ts#L23)
