...
[common/web/api/network/NetworkCommands.ts:28](https://github.com/Soroush9978/rds-ng/blob/9a997cb/src/common/web/api/network/NetworkCommands.ts#L28)
...
[common/web/api/network/NetworkCommands.ts:33](https://github.com/Soroush9978/rds-ng/blob/9a997cb/src/common/web/api/network/NetworkCommands.ts#L33)
