...
• **new PingReply**(`name`, `origin`, `sender`, `target`, `hops?`, `trace?`): [`PingReply`](common_web_api_network_NetworkCommands.PingReply.md)
...
• `Readonly` **payload**: `string` = `"PONG"`

#### Defined in

[common/web/api/network/NetworkCommands.ts:28](https://github.com/Soroush9978/rds-ng/blob/5673246/src/common/web/api/network/NetworkCommands.ts#L28)
...
▸ **build**(`messageBuilder`, `cmd`, `success?`, `message?`): [`CommandReplyComposer`](common_web_core_messaging_composers_CommandReplyComposer.CommandReplyComposer.md)<[`PingReply`](common_web_api_network_NetworkCommands.PingReply.md)\>
...
[common/web/api/network/NetworkCommands.ts:33](https://github.com/Soroush9978/rds-ng/blob/5673246/src/common/web/api/network/NetworkCommands.ts#L33)
