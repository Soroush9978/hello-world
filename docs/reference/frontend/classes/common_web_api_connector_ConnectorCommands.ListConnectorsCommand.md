...
[common/web/api/connector/ConnectorCommands.ts:19](https://github.com/Soroush9978/rds-ng/blob/5673246/src/common/web/api/connector/ConnectorCommands.ts#L19)
