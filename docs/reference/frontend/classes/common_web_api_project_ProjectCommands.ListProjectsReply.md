...
[common/web/api/project/ProjectCommands.ts:34](https://github.com/Soroush9978/rds-ng/blob/9a997cb/src/common/web/api/project/ProjectCommands.ts#L34)
...
[common/web/api/project/ProjectCommands.ts:39](https://github.com/Soroush9978/rds-ng/blob/9a997cb/src/common/web/api/project/ProjectCommands.ts#L39)
