---
id: "common_web_api_project_ProjectCommands.CreateProjectReply"
title: "Class: CreateProjectReply"
sidebar_label: "CreateProjectReply"
custom_edit_url: null
---

[common/web/api/project/ProjectCommands](../modules/common_web_api_project_ProjectCommands.md).CreateProjectReply
...
• **new CreateProjectReply**(`name`, `origin`, `sender`, `target`, `hops?`, `trace?`): [`CreateProjectReply`](common_web_api_project_ProjectCommands.CreateProjectReply.md)
...
[common/web/core/messaging/CommandReply.ts:28](https://github.com/Soroush9978/rds-ng/blob/5673246/src/common/web/core/messaging/CommandReply.ts#L28)
...
[common/web/api/project/ProjectCommands.ts:87](https://github.com/Soroush9978/rds-ng/blob/5673246/src/common/web/api/project/ProjectCommands.ts#L87)
...
[common/web/core/messaging/CommandReply.ts:27](https://github.com/Soroush9978/rds-ng/blob/5673246/src/common/web/core/messaging/CommandReply.ts#L27)
...
[common/web/core/messaging/CommandReply.ts:30](https://github.com/Soroush9978/rds-ng/blob/5673246/src/common/web/core/messaging/CommandReply.ts#L30)
...
[common/web/core/messaging/CommandReply.ts:25](https://github.com/Soroush9978/rds-ng/blob/5673246/src/common/web/core/messaging/CommandReply.ts#L25)
...
[common/web/core/messaging/CommandReply.ts:35](https://github.com/Soroush9978/rds-ng/blob/5673246/src/common/web/core/messaging/CommandReply.ts#L35)
...
▸ **build**(`messageBuilder`, `cmd`, `project_id`, `success?`, `message?`): [`CommandReplyComposer`](common_web_core_messaging_composers_CommandReplyComposer.CommandReplyComposer.md)<[`CreateProjectReply`](common_web_api_project_ProjectCommands.CreateProjectReply.md)\>
...
| `cmd` | [`CreateProjectCommand`](common_web_api_project_ProjectCommands.CreateProjectCommand.md) | `undefined` |
...
[`CommandReplyComposer`](common_web_core_messaging_composers_CommandReplyComposer.CommandReplyComposer.md)<[`CreateProjectReply`](common_web_api_project_ProjectCommands.CreateProjectReply.md)\>

#### Defined in

[common/web/api/project/ProjectCommands.ts:92](https://github.com/Soroush9978/rds-ng/blob/5673246/src/common/web/api/project/ProjectCommands.ts#L92)
